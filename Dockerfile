...
RUN mkdir -p /usr/src/stg_geonode
...
COPY . /usr/src/stg_geonode/
WORKDIR /usr/src/stg_geonode
...
RUN chmod +x /usr/src/stg_geonode/tasks.py \
    && chmod +x /usr/src/stg_geonode/entrypoint.sh
...
ENTRYPOINT /usr/src/stg_geonode/entrypoint.sh
